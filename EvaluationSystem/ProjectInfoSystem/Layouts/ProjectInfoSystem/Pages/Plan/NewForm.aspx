...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="ProjectInfoSystem.Layouts.ProjectInfoSystem.Pages.Plan.NewForm" DynamicMasterPageFile="~masterurl/default.master" %>
                    ...
                    <tr ng-repeat="r in tableData ">
                        ...
                        <td>
                           <%-- <input type="number" ng-model="r.doneWork" ng-model-options="{ updateOn: 'blur' }" ng-change='validateCell(r)' ng-class="{error : !r.hasError}"/></td>--%>
                             <input type="number" ng-model="r.doneWork" ng-model-options="{ updateOn: 'blur' }" ng-change='validateCell(r)' ng-class="{'error' : r.hasError}"/></td>
                        <td>{{r.sum =r.CheckValue-( r.Constructed + r.doneWork)|number:1 }}</td>
                    </tr>
                </tbody>
            </table>
