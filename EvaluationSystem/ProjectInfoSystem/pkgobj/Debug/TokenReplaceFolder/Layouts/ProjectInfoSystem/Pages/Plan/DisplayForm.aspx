...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisplayForm.aspx.cs" Inherits="ProjectInfoSystem.Layouts.ProjectInfoSystem.Pages.Plan.DisplayForm" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
     <div  ng-app="plnApp" ng-controller="plnCtrl">
            ...
            <table  class="container" dir="rtl" >
                <thead>
                    <tr>
                        ...
                        <th class="Constructed" >مقدار انجام شده تاکنون</th>
                        <th class="done-work" >مقدار پلن این دوره</th>
                         <th class="remined-work" >مقدار باقي مانده</th>
                ...
                <tbody>
                    <tr ng-repeat="o in weeklyItem.Items | orderBy : ['OperationId', 'SubOperationId','Measurement']">
                        ...
                        <td>{{o.CheckValue-(o.Constructed+o.doneWork)|number:1}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
